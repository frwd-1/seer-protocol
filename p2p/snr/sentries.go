...
func (g generic) SNRKey() string { return g.key }
...
func (v ID) SNRKey() string { return "id" }
...
func (v IPv4) SNRKey() string { return "ip" }
...
func (v IPv6) SNRKey() string { return "ip6" }
...
func (err *KeyError) Error() string {
	if err.Err == errNotFound {
		return fmt.Sprintf("missing SNR key %q", err.Key)
	}
	return fmt.Sprintf("SNR key %q: %v", err.Key, err.Err)
}
