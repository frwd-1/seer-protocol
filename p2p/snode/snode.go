...
func New(validSchemes snr.IdentityScheme, r *snr.Record) (*Node, error) {
...
func Parse(validSchemes snr.IdentityScheme, input string) (*Node, error) {
...
func (n *Node) Load(k snr.Entry) error {
	return n.r.Load(k)
}
